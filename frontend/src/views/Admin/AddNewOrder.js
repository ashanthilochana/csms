...
// // Variable formatting
// const formattedSendingDate = new Date(AddNewOrderData.sendingDate).toISOString().split('T')[0];
...
//     const { weight, sendingDate, paymentDate,packageTypes,sendingBranch,receivingBranch,speicialNotes,orderStatus,sender,receiver,contactNumber,address } = inpval;

//     try {
//       const res = await AdminController.addOrder(weight, sendingDate, paymentDate,packageTypes,sendingBranch,receivingBranch,speicialNotes,orderStatus,sender,receiver,contactNumber,address);
...
//                 <Input id="receivingBranch" name="receivingBranchs" type="select">
//                   <option>Colombo</option>
//                   <option>Polonnaruwa</option>
//                   <option>Kandy</option>
//                   <option>Galewela</option>
...
//                 <Input id="exampleText" name="text" type="textarea" placeholder="If you have any special notes. Type here..." />
//               </FormGroup>
...
//                 />
//               </FormGroup>
//               <legend className="mt-2">Courier Fee - <b>Rs. 5,000</b></legend>
